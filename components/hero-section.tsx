...
export default function HeroSection({ onButtonClick }: HeroSectionProps) {
  return (
    <div className="text-center py-8 mb-64 mt-[80px] sm:mt-[120px] md:mt-[150px] relative overflow-hidden">
      {/* Logo */}
      <div
      ...
      >
        <div className="relative rounded-lg group">
          <Image
            ...
            width={600}
            height={150}
            className="h-16 sm:h-20 md:h-32 lg:h-36 w-auto select-none transform hover:scale-105 transition-all duration-300"
            priority
            draggable={false}
            style={{
