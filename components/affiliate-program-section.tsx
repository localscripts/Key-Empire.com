...
export default function AffiliateProgramSection() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      setAffiliateLink(`${baseUrl}/affiliate/${affiliateCode}`)
    }
  }, [affiliateCode])
    ...
    >
      ...
      <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 flex items-center justify-center p-12 relative overflow-hidden min-h-[500px]">
        ...
        <div className="text-center max-w-2xl relative z-10">
          ...
          >
            <img
              src="/images/design-mode/KittyPaw08(1).gif"
              alt="Money"
          ...
          <p
            className="text-xl text-gray-600 dark:text-gray-300 mb-6 leading-relaxed max-w-xl mx-auto select-none"
            style={{
              opacity: 0,
