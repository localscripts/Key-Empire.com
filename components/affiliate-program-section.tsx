...
import AffiliateInfoModal from "./affiliate-info-modal"
...
export default function AffiliateProgramSection() {
  ...
  const [isAffiliateInfoModalOpen, setIsAffiliateInfoModalOpen] = useState(false)
  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 flex items-center justify-center p-12 relative overflow-hidden min-h-[500px]">
          ...
          <div className="text-center max-w-2xl relative z-10">
            ...
            >
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/KittyPaw08-EibbsQHYRX8XEmjLQMMSKY7ZnrIGNj.gif"
                alt="Money"
            ...
            >
              ...
              <button
                onClick={() => setIsAffiliateInfoModalOpen(true)}
      ...
      <AffiliateInfoModal
        isOpen={isAffiliateInfoModalOpen}
        onClose={() => setIsAffiliateInfoModalOpen(false)}
        onStartEarning={() => {
          setIsAffiliateInfoModalOpen(false)
