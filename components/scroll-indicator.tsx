...
export default function ScrollIndicator({ show }: ScrollIndicatorProps) {
  return (
    <div
      className="fixed bottom-8 left-1/2 transform -translate-x-1/2 md:left-16 md:transform-none z-50 pointer-events-none transition-all duration-500"
      style={{
        opacity: show ? 1 : 0,
        transform: show ? "translateX(-50%) translateY(0) scale(1)" : "translateX(-50%) translateY(30px) scale(0.9)",
      }}
      id="scroll-indicator"
    >
