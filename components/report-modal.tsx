...
export default function ReportModal({ isOpen, onClose }: ReportModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://api.voxlis.net/report", {
        method: "POST",
        headers: {
      ...
      if (result.status === "success") {
        ...
        setError(result.message || "Failed to send report. Please try again.")
      }
    } catch (err) {
        ...
        {showThankYou ? (
          ...
          >
            <div className="mb-4">
              ...
              <p className="text-gray-600 dark:text-gray-400">Your report has been sent</p>
            </div>
          </div>
        ) : (
          // Report Form
          <div className="p-6">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-green-900 dark:text-green-100 mb-1">What can you report?</h3>
                  <ul className="text-sm text-green-700 dark:text-green-300 space-y-1">
                    <li>• Technical issues or bugs</li>
                    <li>• Content or policy violations</li>
                    <li>• Reseller violations</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              ...
              >
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors resize-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
                ...
                <div className="flex justify-between items-center mt-2">
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Be specific to help us resolve your issue faster
                  </p>
                  <p className="text-xs text-gray-400 dark:text-gray-500">{description.length}/500</p>
                </div>
              </div>
              ...
              >
                <p className="text-xs text-gray-500 dark:text-gray-400">Our team will get your message</p>
              </div>
            </div>
          </div>
        )}
