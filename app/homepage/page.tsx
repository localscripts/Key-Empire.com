...
export default function Homepage() {
  ...
  const executors = [
    ...
    { name: "Fluxus", price: "$1.00", description: "Versatile executor for all your needs" },
    {
      name: "Synapse X",
      price: "$3.50",
      description: "Industry-leading script executor",
    },
  ]
  ...
  return (
    ...
    >
      ...
      <main className="relative z-10">
        ...
        {/* Executors Section */}
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl border border-black/30 shadow-lg overflow-hidden mt-12">
          <div className="p-8">
            <div className="mb-6">
