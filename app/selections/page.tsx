...
export default function SelectionsPage() {
  ...
  const fetchProductResellers = async (productTitle: string, platform?: string) => {
    ...
    try {
      ...
      const sortedDurationKeys = Array.from(uniqueDurationKeys).sort((a, b) => {
        ...
        <div className="w-[95%] max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            <div className="max-w-6xl mx-auto px-4">
              <QuickSelectionsGrid onOpenGetStartedModal={handleGetStartedClick} /> {/* Pass the prop here */}
            </div>
          </div>
                    ...
                    <table className="w-full min-w-[700px]">
                      ...
                      <thead className="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
                        <tr>
                          ...
                          {dynamicDurationTypes.map((key, index) => (
                            <th
                              key={key}
                      ...
                      <tbody>
                        {fetchedResellers.map((reseller, rowIndex) => (
                          ...
                          >
                            ...
                            {dynamicDurationTypes.map((durationKey, priceIndex) => (
                              <td key={durationKey} className="p-4 text-center">
                                {reseller.durations[durationKey] ? (
                                  <a
                                    href={reseller.durations[durationKey]?.url}
                                    target="_blank"
                                  ...
                                  >
                                    <span className="relative z-10">{reseller.durations[durationKey]?.price}</span>
                                  </a>
                                ) : (
                                  <span
