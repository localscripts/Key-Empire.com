...
import { getPaymentMethodIcon, getPaymentMethodName } from "../../lib/payment-methods" // Updated to use new simplified payment methods system
...
const initialSelections = [
  {
    ...
    shadeColor: "purple",
    popular: true,
    hidden: false, // New property to determine visibility
  },
  {
    id: 10,
    title: "Wave",
...
export default function SelectionsPage() {
    ...
    return (
      <Image
        ...
        onError={(e) => {
          ...
          fallback.className = "text-xs text-gray-600 dark:text-gray-400 capitalize"
          fallback.textContent = method
  ...
  const displayedSelections = getVisibleProducts().map((selection) => ({
    ...selection,
  ...
  const filteredSelections = displayedSelections.filter((selection) =>
    ...
    >
      ...
      <main className="px-4 py-8 mt-40 relative z-10 md:mt-32">
        <div className="w-[95%] max-w-7xl mx-auto">
          ...
          {/* Products Grid */}
          <ProductsGrid
            selections={currentProducts} // Use paginated and filtered products
            ...
            <div className="mb-16">
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Showing {startIndex + 1}-{Math.min(endIndex, filteredSelections.length)} of{" "}
                  {filteredSelections.length} products
                  {searchQuery && (
                    <span className="ml-1">
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                  <div
                    ...
                    style={{
                      ...
                      animation: isResellersExiting
                        ? "iconSpinOut 0.3s cubic-bezier(0.68, -0.55, 0.265, 1.55) forwards"
                        : "iconSpinIn 0.4s cubic-bezier(0.68, -0.55, 0.265, 1.55) 0.5s forwards",
                    }}
                  >
