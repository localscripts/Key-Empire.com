...
export const PAYMENT_METHODS: { [key: string]: { name: string; icon: React.ReactNode } } = {
  paypal: {
    name: "PayPal",
    icon: <Image src="/images/paypal-icon.png" alt="PayPal" width={20} height={20} draggable={false} />,
  },
  stripe: {
    name: "Stripe",
    icon: <Image src="/images/stripe-icon.png" alt="Stripe" width={20} height={20} draggable={false} />,
  },
  crypto: {
    name: "Crypto",
