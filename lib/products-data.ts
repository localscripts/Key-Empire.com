...
export const PRODUCTS_LIST: ProductData[] = [
  ...
  },
  {
    ...
    popular: true,
    category: "executor",
    description: "Advanced executor with premium capabilities",
  },
  {
    id: 19,
    title: "Valex",
    ...
    popular: false,
    category: "executor",
    description: "Lightweight and efficient executor",
  },
  {
    id: 20,
    title: "Assembly",
    ...
    popular: false,
    category: "executor",
    description: "Modular executor with customizable features",
  },
  {
    id: 21,
    title: "Serotonin",
    ...
    popular: false,
    category: "executor",
    description: "Smooth and reliable executor experience",
  },
  {
    id: 22,
    title: "Matcha",
    ...
    popular: false,
    category: "executor",
    description: "Clean and minimalist executor interface",
  },
  {
    id: 23,
    title: "Aureus",
    ...
    popular: false,
    category: "executor",
    description: "Golden standard executor with premium features",
  },
  {
    id: 24,
    title: "Potassium",
    ...
    popular: false,
    category: "executor",
    description: "Essential executor for basic scripting needs",
  },
  {
    id: 25,
    title: "CodeX",
    ...
    popular: false,
    category: "executor",
    description: "Developer-focused executor with advanced tools",
  },
  {
    id: 26,
    title: "Volcano",
    ...
    popular: false,
    category: "executor",
    description: "Powerful executor with explosive performance",
  },
  {
    id: 27,
    title: "Isabelle",
    ...
    popular: false,
    category: "executor",
    description: "User-friendly executor with intuitive design",
  },
