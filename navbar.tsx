              ...
              <Link href="/" className="flex items-center group">
                <div className="relative rounded-lg">
                  <Image
                    ...
                    width={160}
                    height={40}
                    // Adjusted logo sizing for responsiveness
                    className="h-5 sm:h-7 md:h-9 lg:h-10 w-auto select-none transform group-hover:scale-105 transition-all duration-300 drop-shadow-lg"
                    priority
                    draggable={false}
                    style={{
